...
from sanic.response import JSONResponse, HTTPResponse, json, raw
...
class Raw(Response):
    """
    Classe pour les réponses brutes
    """
    ...
    def generate(self) -> HTTPResponse:
        ...
        :return: HTTPResponse
        """
        return raw(body=self.data, status=self.status, content_type=self.content_type)

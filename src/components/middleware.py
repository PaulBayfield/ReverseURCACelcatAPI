    ...
    def __init__(self, app: Sanic) -> None:
        ...
        async def after_request(request: Request, response):
            ...
            if hasattr(request.ctx, "process_time_start"):
                ...
                print(f"Le temps de traitement n'est pas défini pour la requête {request.ctx.request_id} ({request.method} {request.path})")
            ...
            response.headers["X-API"] = "ReverseURCACelcatAPI"
